...
public class AntPathMatcherTests {
    ...
    public void match() {
        // test exact matching
        assertTrue(pathMatcher.canMatch("test", "test"));
        assertTrue(pathMatcher.canMatch("/test", "/test"));
        assertTrue(pathMatcher.canMatch("http://example.org", "http://example.org")); // SPR-14141
        assertFalse(pathMatcher.canMatch("/test.jpg", "test.jpg"));
        assertFalse(pathMatcher.canMatch("test", "/test"));
        assertFalse(pathMatcher.canMatch("/test", "test"));

        // test matching with ?'s
        assertTrue(pathMatcher.canMatch("t?st", "test"));
        assertTrue(pathMatcher.canMatch("??st", "test"));
        assertTrue(pathMatcher.canMatch("tes?", "test"));
        assertTrue(pathMatcher.canMatch("te??", "test"));
        assertTrue(pathMatcher.canMatch("?es?", "test"));
        assertFalse(pathMatcher.canMatch("tes?", "tes"));
        assertFalse(pathMatcher.canMatch("tes?", "testt"));
        assertFalse(pathMatcher.canMatch("tes?", "tsst"));

        // test matching with *'s
        assertTrue(pathMatcher.canMatch("*", "test"));
        assertTrue(pathMatcher.canMatch("test*", "test"));
        assertTrue(pathMatcher.canMatch("test*", "testTest"));
        assertTrue(pathMatcher.canMatch("test/*", "test/Test"));
        assertTrue(pathMatcher.canMatch("test/*", "test/t"));
        assertTrue(pathMatcher.canMatch("test/*", "test/"));
        assertTrue(pathMatcher.canMatch("*test*", "AnothertestTest"));
        assertTrue(pathMatcher.canMatch("*test", "Anothertest"));
        assertTrue(pathMatcher.canMatch("*.*", "test."));
        assertTrue(pathMatcher.canMatch("*.*", "test.test"));
        assertTrue(pathMatcher.canMatch("*.*", "test.test.test"));
        assertTrue(pathMatcher.canMatch("test*aaa", "testblaaaa"));
        assertFalse(pathMatcher.canMatch("test*", "tst"));
        assertFalse(pathMatcher.canMatch("test*", "tsttest"));
        assertFalse(pathMatcher.canMatch("test*", "test/"));
        assertFalse(pathMatcher.canMatch("test*", "test/t"));
        assertFalse(pathMatcher.canMatch("test/*", "test"));
        assertFalse(pathMatcher.canMatch("*test*", "tsttst"));
        assertFalse(pathMatcher.canMatch("*test", "tsttst"));
        assertFalse(pathMatcher.canMatch("*.*", "tsttst"));
        assertFalse(pathMatcher.canMatch("test*aaa", "test"));
        assertFalse(pathMatcher.canMatch("test*aaa", "testblaaab"));

        // test matching with ?'s and /'s
        assertTrue(pathMatcher.canMatch("/?", "/a"));
        assertTrue(pathMatcher.canMatch("/?/a", "/a/a"));
        assertTrue(pathMatcher.canMatch("/a/?", "/a/b"));
        assertTrue(pathMatcher.canMatch("/??/a", "/aa/a"));
        assertTrue(pathMatcher.canMatch("/a/??", "/a/bb"));
        assertTrue(pathMatcher.canMatch("/?", "/a"));

        // test matching with **'s
        assertTrue(pathMatcher.canMatch("/**", "/testing/testing"));
        assertTrue(pathMatcher.canMatch("/*/**", "/testing/testing"));
        assertTrue(pathMatcher.canMatch("/**/*", "/testing/testing"));
        assertTrue(pathMatcher.canMatch("/bla/**/bla", "/bla/testing/testing/bla"));
        assertTrue(pathMatcher.canMatch("/bla/**/bla", "/bla/testing/testing/bla/bla"));
        assertTrue(pathMatcher.canMatch("/**/test", "/bla/bla/test"));
        assertTrue(pathMatcher.canMatch("/bla/**/**/bla", "/bla/bla/bla/bla/bla/bla"));
        assertTrue(pathMatcher.canMatch("/bla*bla/test", "/blaXXXbla/test"));
        assertTrue(pathMatcher.canMatch("/*bla/test", "/XXXbla/test"));
        assertFalse(pathMatcher.canMatch("/bla*bla/test", "/blaXXXbl/test"));
        assertFalse(pathMatcher.canMatch("/*bla/test", "XXXblab/test"));
        assertFalse(pathMatcher.canMatch("/*bla/test", "XXXbl/test"));

        assertFalse(pathMatcher.canMatch("/????", "/bala/bla"));
        assertFalse(pathMatcher.canMatch("/**/*bla", "/bla/bla/bla/bbb"));

        assertTrue(pathMatcher.canMatch("/*bla*/**/bla/**", "/XXXblaXXXX/testing/testing/bla/testing/testing/"));
        assertTrue(pathMatcher.canMatch("/*bla*/**/bla/*", "/XXXblaXXXX/testing/testing/bla/testing"));
        assertTrue(pathMatcher.canMatch("/*bla*/**/bla/**", "/XXXblaXXXX/testing/testing/bla/testing/testing"));
        assertTrue(pathMatcher.canMatch("/*bla*/**/bla/**", "/XXXblaXXXX/testing/testing/bla/testing/testing.jpg"));

        assertTrue(pathMatcher.canMatch("*bla*/**/bla/**", "XXXblaXXXX/testing/testing/bla/testing/testing/"));
        assertTrue(pathMatcher.canMatch("*bla*/**/bla/*", "XXXblaXXXX/testing/testing/bla/testing"));
        assertTrue(pathMatcher.canMatch("*bla*/**/bla/**", "XXXblaXXXX/testing/testing/bla/testing/testing"));
        assertFalse(pathMatcher.canMatch("*bla*/**/bla/*", "XXXblaXXXX/testing/testing/bla/testing/testing"));

        assertFalse(pathMatcher.canMatch("/x/x/**/bla", "/x/x/x/"));

        assertTrue(pathMatcher.canMatch("/foo/bar/**", "/foo/bar"));

        assertTrue(pathMatcher.canMatch("", ""));

        assertTrue(pathMatcher.canMatch("/{bla}.*", "/testing.html"));
    }
    ...
    public void trimTokensOff() {
        ...
        assertTrue(pathMatcher.canMatch("/group/{groupName}/members", "/group/sales/members"));
        assertTrue(pathMatcher.canMatch("/group/{groupName}/members", "/group/  sales/members"));
        assertFalse(pathMatcher.canMatch("/group/{groupName}/members", "/Group/  Sales/Members"));
    }
    ...
    public void defaultCacheSetting() {
        ...
        for (int i = 0; i < 65536; i++) {
            pathMatcher.canMatch("test" + i, "test");
        }
    ...
    public void cachePatternsSetToTrue() {
        ...
        for (int i = 0; i < 65536; i++) {
            pathMatcher.canMatch("test" + i, "test" + i);
        }
    ...
    public void preventCreatingStringMatchersIfPathDoesNotStartsWithPatternPrefix() {
        ...
        pathMatcher.canMatch("test?", "test");
        assertEquals(1, pathMatcher.stringMatcherCache.size());

        pathMatcher.canMatch("test?", "best");
        pathMatcher.canMatch("test/*", "view/test.jpg");
        pathMatcher.canMatch("test/**/test.jpg", "view/test.jpg");
        pathMatcher.canMatch("test/{name}.jpg", "view/test.jpg");
        assertEquals(1, pathMatcher.stringMatcherCache.size());
    }
    ...
    public void creatingStringMatchersIfPatternPrefixCannotDetermineIfPathMatch() {
        ...
        pathMatcher.canMatch("test", "testian");
        pathMatcher.canMatch("test?", "testFf");
        pathMatcher.canMatch("test/*", "test/dir/name.jpg");
        pathMatcher.canMatch("test/{name}.jpg", "test/lorem.jpg");
        pathMatcher.canMatch("bla/**/test.jpg", "bla/test.jpg");
        pathMatcher.canMatch("**/{name}.jpg", "test/lorem.jpg");
        pathMatcher.canMatch("/**/{name}.jpg", "/test/lorem.jpg");
        pathMatcher.canMatch("/*/dir/{name}.jpg", "/*/dir/lorem.jpg");
