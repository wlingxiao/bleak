...
public interface PathMatcher {
     ...
     * <p>If the return value is {@code false}, then the {@link #canMatch}
     ...
     */
    boolean canMatch(String pattern, String path);
     ...
     * path goes, assuming that a full path may then canMatch as well.
     *
     * @param pattern the pattern to canMatch against
     * @param path    the path String to test
     * @return {@code true} if the supplied {@code path} matched,
